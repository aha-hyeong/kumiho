...
describe("EpubViewer UI", () => {
  ...
  it("should toggle fullscreen on f key when no modal is open", () => {
    const props = createDefaultProps();
  ...
  it("should not toggle fullscreen on f key when settings is open", () => {
    const props = createDefaultProps();
  ...
  it("should not toggle fullscreen on f key when toc is open", () => {
    const props = createDefaultProps();
  ...
  it("should not toggle fullscreen on f key when chapter list is open", () => {
    const props = createDefaultProps();
